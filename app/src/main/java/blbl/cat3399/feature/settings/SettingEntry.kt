...
enum class SettingId(
    ...
    RangeDownloadEnabled("range_download_enabled"),
    RangeDownloadAutomatic("range_download_automatic"),
    RangeDownloadConnections("range_download_connections"),
    RangeDownloadCdnMode("range_download_cdn_mode"),
    RangeDownloadRescue("range_download_rescue"),
    RangeDownloadMemory("range_download_memory"),
    RangeDownloadDebug("range_download_debug"),
